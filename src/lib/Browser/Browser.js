...
export function browserInfo() {
    ...
    var regexes = {
        ...
        try {
            ...
            var ua = ((window && window.navigator && window.navigator.userAgent) ? window.navigator.userAgent : EMPTY);
            var rgxmap = regexes;
            ...
            var device = {vendor: undefined, model: undefined, type: "desktop"};
            ...
            cachedInfo = {
                ...
                device: device.type,
                deviceVendor: device.vendor === undefined ? null : device.vendor,
                deviceModel: device.model === undefined ? "" : device.model,
